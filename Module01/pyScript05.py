...
print(int(2.8)) # notice that int does not round, it drops . and after
print(int(1.1))
...
print(((myString + " ")*2)[:-1]) # doubles with space at end, but removes final space          
...
print(montyPythonQuote.split('.')[0])
print("==================================")
...
numbers.append(5)
numbers.append([6,7,8]) # you can put a list in a list

numbers[0] = 0 # easy to edit items in a list

numbers.remove(2) # finds objects and removes
numbers.pop(0) # pop removed by index
numbers.insert(0,2) # inserts an item at an index
numbers.insert(0,1) # inserts an item at an index
numbers.pop(5)

# numbers.sort() # won't work because of different data types
print(numbers)
...
# remove Diana item from dictionary
phonelist.pop('Diana')
print(phonelist)
