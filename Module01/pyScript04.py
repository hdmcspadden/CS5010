...
record = 'Example1: %s: %.2f' % (name, grade)
print(record)

record2 = "Example2 %s: %i" % (name, grade)
print(record2)

record3 = "Example3: %s: %.3f" % (name, grade)
print(record3)

record4 = "Example4: {namefield:s}: {scorefield:.2f}"
print(record4.format(namefield = name, scorefield = grade))

txt = "Example5: You scored {:.0%}"
print(txt.format(grade_perc))
